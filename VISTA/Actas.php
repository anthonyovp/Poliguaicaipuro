      ...
      $(document).ready(function() {
         ...
         $("#buscar").keyup(function(){
          ...
          if(dato.length > 0){
            ...
            primeraFila+="<td class = 'verdeoscuroimg' > Ejem.Sector </td>";                            
            primeraFila+="<td class = 'verdeoscuroimg' > Ejem.Funcionarios </td>";
            primeraFila+="<td class = 'verdeoscuroimg' > Ejem.Procedimientos </td>";
