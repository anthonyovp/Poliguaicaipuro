  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="Principal.php">Inicio</a></li>  &nbsp;/&nbsp;&nbsp;<i class="glyphicon glyphicon-earphone"></i>&nbsp;Contactos
          ...
          <section id="miSlide" class="carousel slide">
               ...
               <div class="portlets">
                    ...
                    <div class="panel panel-default">
                        ...
                        <center><h2><strong>Contactos</strong></h2></center>
                           
                 
                        </div>
                        <div class="panel-body text-justify">
                         <strong>Nuestro Teléfono: </strong>(0212) 321-10-01<br>
                        <strong>Nuestro Correo: </strong>policia@alcaldiadeguaicaipuro.gob.ve
                         <br><br>
                          <center><img src="../img/contactos.jpg" class="img img-responsive img-rounded hidden-xs" width="100%" height="58%"></center>
                        </div>
                    </div> 
                </div>
