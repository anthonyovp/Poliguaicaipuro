<?php 
	...
	$pdf->AddPage();
	$sql = "SELECT cedula_per,nombre1_per,nombre2_per,apellido1_per,apellido2_per,credencial_fun,status_fun FROM Persona  INNER JOIN Funcionario ON Persona.codigo_per = Funcionario.cod_per WHERE status_fun = 'Activo' ORDER BY cedula_per ASC ";
