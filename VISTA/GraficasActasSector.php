...
<script src="../Highcharts-4.1.5/js/highcharts.js"></script>
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <form  action="GraficasActasSector2.php" method="POST">        
            <div class="login-wrap">
                  ...
                  <table align="center">
                    <tr>
                      <td colspan="2">
                        <center>Buscar Sectores en un Año:</center>
                        <br>
                      </td>
                    ...
                    <tr>
                      <td>
                          <center><input type="number" class="form-control" name="anio" required placeholder="Año a Buscar" autofocus> </center>
                      </td>
                      <td>
                         <center><button class="btn btn-primary " name="buscar" type="submit">Buscar</button></center>                
                      </td>
...
$(function () {
    $('#unico').highcharts({
        ...
        title: {
            text: 'Porcentaje de Actas por Sectores'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
              ...
              <?php
                 $obj->conectar();
                 $sql="SELECT DISTINCT sector_act FROM acta ORDER BY sector_act DESC";
                 $datos=$obj->consulta_query($sql);
                 while($fila = mysqli_fetch_array($datos)){

                      $sector=$fila['sector_act'];
                      $sql2="SELECT * FROM acta where sector_act='$sector'";
...
$(function () {
    ...
    $('#unico2').highcharts({
        ...
        title: {
            text: 'Total de Actas por Sectores',
            x: -50
        },
        plotOptions: {
            series: {
