...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
             <a href="Principal.php" class="logo"><img src="../img/logo.png" alt=""/ width="9%"> Poli <span class="lite">Guaicaipuro</span>&nbsp;&nbsp;<img src="../img/logoalcaldia.jpg" alt="" width="17%" class="hidden-xs"/></a>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                 ...
                 <li class="sub-menu">
                            ...
                            <li><a class="" href="Mision.php"><i class="glyphicon glyphicon-thumbs-up"></i>Nuestra Misión</a></li>                          
                            <li><a class="" href="Vision.php"><i class="glyphicon glyphicon-eye-open"></i>Nuestra Visión</a></li>
                            <li><a class="" href="Organigrama.php"><i class="glyphicon glyphicon-list"></i>Organigrama</a></li>
                            <li><a class="" href="Ubicacion.php"><i class="glyphicon glyphicon-road"></i>Ubicación</a></li>
                            <li><a class="" href="Contactos.php"><i class="glyphicon glyphicon-earphone"></i>Contactos</a></li>
      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="Principal.php">Inicio</a></li>  &nbsp;/&nbsp;&nbsp;<i class="glyphicon glyphicon-thumbs-up"></i>&nbsp;Misión
          ...
          <section id="miSlide" class="carousel slide">
               ...
               <div class="portlets">
                    ...
                    <div class="panel panel-default">
                        ...
                        <center><h2><strong>Misión</strong></h2></center>
                           
                 
                        </div>
                        <div class="panel-body text-justify">
                         
                            El Servicio de la Policía Municipal tiene como fin garantizar la seguridad de los ciudadanos o ciudadanas y bienes, la preservación del Orden Público, así como velar por el mantenimiento de la Moralidad, Urbanismo, Salubridad, cuido del Medio Ambiente, regular el tránsito Automotor y peatonal, incentivar y promover el turismo, promoviendo el acercamiento, proximidad, pro actividad y comprometidos en el respeto de los valores, la identidad y la cultura propia de la Comunidad, fomentando el trabajo coordinado dirigido a la resolución de los problemas de la población del Municipio Guaicaipuro, enfocados en el nuevo modelo de la Policía Comunal. Velando por el fiel cumplimiento de la Constitución y demás Leyes Nacionales que rijan las materias respectivas en la jurisdicción del Municipio Guaicaipuro.
                          <br><br>
                          <center><img src="../img/mision.jpg" class="img img-responsive img-rounded hidden-xs" width="66%" height="58%"></center>
                        </div>
                    </div> 
                </div>
