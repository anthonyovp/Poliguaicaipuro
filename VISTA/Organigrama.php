  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="Principal.php">Inicio</a></li>  &nbsp;/&nbsp;&nbsp;<i class="glyphicon glyphicon-list"></i>&nbsp;Organigrama
          ...
          <section id="miSlide" class="carousel slide">
               ...
               <div class="portlets">
                    ...
                    <div class="panel panel-default">
                        ...
                        <center><h2><strong>Organigrama</strong></h2></center>
                           
                 
                        </div>
                        <div class="panel-body text-justify">
                         A continuación se presenta la manera en que se encuentra organizado nuestro Instituto:<br><br>
                          <center><img src="../img/organigrama.jpg" class="img img-responsive img-rounded hidden-xs" width="100%" height="58%"></center>
                        </div>
                    </div> 
                </div>
