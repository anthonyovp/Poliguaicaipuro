  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="Principal.php">Inicio</a></li>  &nbsp;/&nbsp;&nbsp;<i class="glyphicon glyphicon-road"></i>&nbsp;Ubicación
          ...
          <section id="miSlide" class="carousel slide">
               ...
               <div class="portlets">
                    ...
                    <div class="panel panel-default">
                        ...
                        <center><h2><strong>Ubicación</strong></h2></center>
                           
                 
                        </div>
                        <div class="panel-body text-justify">
                         Estamos ubicados en la Avenida Bicentenaria, Coordinación General de Estaciones Policiales del Municipio Autónomo Guaicaipuro. Los Teques - Estado Miranda. <br><br>
                          <center><img src="../img/ubicacion.jpg" class="img img-responsive img-rounded hidden-xs" width="100%" height="58%"></center>
                        </div>
                    </div> 
                </div>
