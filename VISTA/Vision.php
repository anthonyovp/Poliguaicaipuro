  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="Principal.php">Inicio</a></li>  &nbsp;/&nbsp;&nbsp;<i class="glyphicon glyphicon-eye-open"></i>&nbsp;Visión
          ...
          <section id="miSlide" class="carousel slide">
               ...
               <div class="portlets">
                    ...
                    <div class="panel panel-default">
                        ...
                        <center><h2><strong>Visión</strong></h2></center>
                           
                 
                        </div>
                        <div class="panel-body text-justify">
                         
                           El servicio de Policía Municipal estará conformado por personal civil armado, uniformado, capacitado profesionalmente y jerarquizado, basando sus funciones en regímenes de disciplina especiales y procedimientos de conformidad con lo establecido en la Constitución de la República Bolivariana de Venezuela, la Constitución del Estado Bolivariano de Miranda, las Leyes, Ordenanzas y reglamentos respectivos.
                          <br><br>
                          <center><img src="../img/vision.jpg" class="img img-responsive img-rounded hidden-xs" width="100%" height="58%"></center>
                        </div>
                    </div> 
                </div>
